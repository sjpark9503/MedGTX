        ...
        for _rc in [False]:
            for _align in [True]:
                ...
                assert TASK_NAME in ['pretrain', 'binary_retrieval', 'text_retrieval', 'graph_retrieval','generation', 'adm_lvl_prediction',
                                    'single_pretrain',  'single_binary_retrieval', 'single_text_retrieval', 'single_graph_retrieval', 'single_generation', 'single_adm_lvl_prediction'], "Task not supported"
                ...
                if (TASK_NAME in ['pretrain', 'single_pretrain']) or Scratch_Downstream:
                    ...
                    if Evaluation:
                        ...
                        elif TASK_NAME in ['adm_lvl_prediction', 'single_adm_lvl_prediction']:
                            Config['cross_att_type'] = 'single' if TASK_NAME.split('_')[0] == 'single' else 'cross'
